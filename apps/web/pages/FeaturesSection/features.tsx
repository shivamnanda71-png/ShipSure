  ...
  return (
    <>
      <div className="relative max-w-7xl mx-auto mt-10 pt-10 h-auto">
        <h2 className="text-center text-5xl mb-2 font-bold">Why <span className="text-blue-600">choose</span> us?</h2>
        <p className="text-center text-2xl mb-1">
          Here is what makes us the leading provider of ecommerce shipping
          solutions in India
        </p>
